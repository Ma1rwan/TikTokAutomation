...
BGVideosDirectory = r"D:\videos\stories\BGVideos2"
# Folder where the original videos contained
originalVideosDirectory = r'D:\videos\stories\originalStoryVideos2'
...
for video in videos:
    ...
    outputDirectory = Path(rf'D:\videos\stories\outputStories2\{video[:-4]}')
